...
void OBJObject::draw(GLuint shaderProgram)
{
    ...
    glUniform3f(glGetUniformLocation(shaderProgram, "material.ambient"), .135f, .2225f, .1575f);
    glUniform3f(glGetUniformLocation(shaderProgram, "material.diffuse"), .54f, .89f, .63f);
    glUniform3f(glGetUniformLocation(shaderProgram, "material.specular"), .316228f, .316228f, .316228f);
    glUniform1f(glGetUniformLocation(shaderProgram, "material.shininess"), .1f);
    ...
    glUniform3f(glGetUniformLocation(shaderProgram, "dirLight.diffuse"), 0.2f, 0.2f, 0.7f);
    ...
    glUniform3f(glGetUniformLocation(shaderProgram, "spotLights.position"), 0.0,5.0*(640.0/30.0),0.0);
    glUniform3f(glGetUniformLocation(shaderProgram, "spotLight.direction"), 0.0f, -1.0f, 0.0f);

    
    glUniform3f(glGetUniformLocation(shaderProgram, "spotLight.ambient"), pointLightColors[0].x * 0.1,  pointLightColors[0].y * 0.1,  pointLightColors[0].z * 0.1);
    
    glUniform3f(glGetUniformLocation(shaderProgram, "spotLight.diffuse"), pointLightColors[0].x,  pointLightColors[0].y,  pointLightColors[0].z);
    
    glUniform3f(glGetUniformLocation(shaderProgram, "spotLight.specular"), pointLightColors[0].x,  pointLightColors[0].y,  pointLightColors[0].z);
    ...
    glUniform1f(glGetUniformLocation(shaderProgram, "spotLight.outerCutOff"), glm::cos(glm::radians(outer)));
    
    
    glUniform3f(glGetUniformLocation(shaderProgram, "pointLights.position"), 10.0,0.0,0.0);
    
    //glUniform3f(glGetUniformLocation(shaderProgram, "pointLights.ambient"), pointLightColors[0].x * 0.1,  pointLightColors[0].y * 0.1,  pointLightColors[0].z * 0.1);
    glUniform3f(glGetUniformLocation(shaderProgram, "pointLights.ambient"),0,  0, 0);
    glUniform3f(glGetUniformLocation(shaderProgram, "pointLights.diffuse"), pointLightColors[0].x,  pointLightColors[0].y,  pointLightColors[0].z);
    
    glUniform3f(glGetUniformLocation(shaderProgram, "pointLights.specular"), pointLightColors[0].x,  pointLightColors[0].y,  pointLightColors[0].z);
    
    glUniform1f(glGetUniformLocation(shaderProgram, "pointLights.constant"), 1.0f);
    
    glUniform1f(glGetUniformLocation(shaderProgram, "pointLights.linear"), 0.09);
    
    glUniform1f(glGetUniformLocation(shaderProgram, "pointLights.quadratic"), 0.032);
